...
# --------------------
class SkinToneAutoencoder(nn.Module):
    def __init__(self):
        super(SkinToneAutoencoder, self).__init__()
...
# Training Function
# --------------------
def train_skin_tone_autoencoder(
    data_dir, 
    output_dir, 
    log_dir, 
    batch_size=32, 
    ...
    dataset = SkinToneDataset(data_dir, transform)
    ...
    # Save the model
    model_save_path = model_save_path or os.path.join(output_dir, "skin_tone_autoencoder.pth")
...
# --------------------
def load_skin_tone_autoencoder(model_path, device="cuda" if torch.cuda.is_available() else "cpu"):
    model = SkinToneAutoencoder()
...
if __name__ == "__main__":
    train_skin_tone_autoencoder(
        data_dir=r"C:\Users\anees\dataset\custom_gans\male_female_gan_project\raw images\img_align_celeba",
        output_dir=r"C:\Users\anees\dataset\custom_gans\Skin_Tone_Enhancement\outputs",
        log_dir=r"C:\Users\anees\dataset\custom_gans\Skin_Tone_Enhancement\logs",
        batch_size=32,
        lr=0.003,
        epochs=20
    )
